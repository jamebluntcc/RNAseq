...
conditions = factor(c(rep(each_pair[2], length(con1_sample)), rep(each_pair[1], length(con2_sample))), levels = c(each_pair[2], each_pair[1]))
...
each_pair_matrix <- gene_tpm_matrix[,c(con2_sample, con1_sample)]
